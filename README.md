...
Though the last paper is about mpox it, along with the prior paper, deal with time delay distribution modelling, how to deal with coarsely collected data.
